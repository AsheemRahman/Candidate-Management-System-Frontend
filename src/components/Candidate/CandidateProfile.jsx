...
function CandidateProfile() {
    ...
    const handleSignOut = async () => {
        try {
            await fetch('https://candidate-management-system-backend.onrender.com/api/candidate/signout');
            dispatch(signOut());
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await fetch(`https://candidate-management-system-backend.onrender.com/api/candidate/upload/${currentUser._id}`, {
                method: 'POST',
